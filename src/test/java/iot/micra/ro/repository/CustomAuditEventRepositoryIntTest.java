package iot.micra.ro.repository;

import iot.micra.ro.IoTApp;
import iot.micra.ro.config.Constants;
import iot.micra.ro.config.audit.AuditEventConverter;
import iot.micra.ro.domain.PersistentAuditEvent;
...
import static iot.micra.ro.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
